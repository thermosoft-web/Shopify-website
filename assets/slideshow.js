  ...
  class SlideShow extends HTMLElement {
        ...
        args.on = {
          ...
          ready: function () {
            ...
            if (
                ...
                flkty &&
                Array.isArray(flkty.cells) &&
                flkty.cells.length > 0 &&
                flkty.cells[0] &&
                flkty.cells[0].element
              ) {
    ...
    prepareAnimations(slideshow, animations) {
      if (!slideshow.dataset.animationsReady) {
        let splittext = new SplitText(slideshow.querySelectorAll('.slideshow__slide-heading:not(.slideshow__slide_wrapper), p:not(.subheading)'), {
          type: 'lines',
          linesClass: 'line-child'
        });
        let mask = new SplitText(slideshow.querySelectorAll('.slideshow__slide-heading:not(.slideshow__slide_wrapper), p:not(.subheading)'), {
          type: 'lines',
        ...
        slideshow.querySelectorAll('.slideshow__slide').forEach((item, i) => {
          ...
          if (item.querySelector('.slideshow__slide-heading:not(.slideshow__slide_wrapper)')) {
            let h1_duration = 1 + ((item.querySelectorAll('.slideshow__slide-heading:not(.slideshow__slide_wrapper) .line-child').length - 1) * 0.1);
            tl

              .set(item.querySelectorAll('.slideshow__slide-heading:not(.slideshow__slide_wrapper)'), {
                opacity: 1
              }, 0)
              .from(item.querySelectorAll('.slideshow__slide-heading:not(.slideshow__slide_wrapper) .line-child'), {
